...
def pull_screenshot(name="autojump.png"):
    jtcmd='adb shell screencap -p /sdcard/a.png'
    # print(jtcmd)
    result=runCmd('adb shell screencap -p /sdcard/a.png')

    print('it is screenshot success.....')
    # print(result)
    print('it is moving screenshot to pc.....')
    jtcmd='adb pull /sdcard/a.png C:\Python\wechat_jump_end_to_end-master'+'\\' + 'autojump.png'
    # print(jtcmd)
    result=runCmd(jtcmd)
